...
// This example shows how to watch changes made on file-system by text editors
...
// This example shows how to use the Sys() method from EventInfo interface to
// tie two separate events generated by rename(2) function.
